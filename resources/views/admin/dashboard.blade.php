    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box">
                        <div class="box-header"><h3 class="box-title"><i class="fa fa-exclamation-circle"></i> ТОП
                                популярных продуктов</h3></div>
                        <div class="box-body no-padding" style="background: #FFFFFF;">
                            ...
                            <table class="table table-condensed">
                                ...
                                @foreach ($topProds as $prod)
                                    <tr>
                                        <td>{{$i}}</td>
                                        <td><a href="{{URL::to('/'.$prod['urlhash'].'.html')}}">{{$prod['name'] }} </a>
                                        </td>
                                        <td>
                                            {{$prod['qty'] }}
                                        </td>
                ...
                <div class="col-md-6">
                    <div class="box">
                        <div class="box-header"><h3 class="box-title"><i class="fa fa-globe"></i> График посещений</h3>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <div class="box-header">
                            <h3 class="box-title"><a href="{{URL::to('/orders')}}"><i class="fa fa-list-alt"></i>
                                    Последние заказы</a></h3>
                        </div>
                            ...
                            <table id="example1" class="table table-bordered">
                                ...
                                @foreach ($orders as $order)
                                    ...
                                    <tr class="{{$order->rowStyle}}">
                                        ...
                                        <td>
                                            <center><span data-toggle="tooltip" data-placement="right" title="
                    {{ LocalizedCarbon::parse($order->created_at)->format('d M Y H:i:s') }}
                                                        ">
                    <small>{{ LocalizedCarbon::instance($order->created_at)->diffForHumans() }}</small></span></center>
                                        </td>
                                        <td>
                                            <center>
                                                ...
                                                <center>
                                                    <small>
                                                        @if ($order->itemGift == true)
                                                            <span class="label label-info"><em class="info_client"><i
                                                                            class="fa fa-gift"></i></em></span>
                                                        @endif
                                                        @if ($order->itemFast == true)
                                                            <span class="label label-danger"><em class="info_client"><i
                                                                            class="fa fa-clock-o"></i></em></span>
                                                        @endif
                                        ...
                                        <td>
                                            <center><span data-toggle="tooltip" data-html="true" data-placement="right"
                                                          title="Tel: {{$order->client->tel}} <br> Email: {{$order->client->email}}">
                <small>{{$order->client->name}}</small></span></center>
                                        </td>
                                        <td>
                                            <center>
                                                <small>{!! $order->totalCount !!}</small>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                                <small>{!! $order->totalSumm !!}</small>
                                            </center>
                                        </td>
                                        <td>
                                                ...
                                                <small>
                                                    <div class="btn-group" style="">
                                                        ...
                                                        <button type="button" data-id="{{$order->id}}"
                                                                class="btn btn-default btn-xs enter_ttn"><i
                                                                    class="fa fa-tag"></i></button>
                                                        <button type="button" data-id="{{$order->id}}"
                                                                class="btn btn-default btn-xs remove"><i
