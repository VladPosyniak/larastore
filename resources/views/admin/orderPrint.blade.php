                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <small>{!! $order->delivery_city !!}
                                                        , {!! $order->delivery_np !!} {!! $order->delivery_adr !!}</small>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            @foreach ($order->items()->orderby('product_id','asc')->get() as $row)
                                                @if ($row->product_id == 'np')
                                                    <tr id="tr_" class="warning">
                                                        ...
                                                        <td style=" vertical-align: inherit; " colspan="2">
                                                            <small>Доставка "до дверей" (курьер Новой Почты)</small>
                                                        </td>

                                                        <td id="price_" name="cost" val="" colspan="2"
                                                            style=" vertical-align: inherit; ">
                                                            <center>
                                                                <small>{!! Setting::get('product.np') !!}</small>
                                                            </center>
                                                        </td>
                                                ...
                                                @elseif ($row->product_id == 'gift')
                                                    <tr id="tr_" class="warning">
                                                        ...
                                                        <td style=" vertical-align: inherit; "></td>
                                                        <td style=" vertical-align: inherit; ">
                                                            <small>Подарочная упаковка</small>
                                                        </td>
                                                        <td style=" vertical-align: inherit; ">
                                                            <small>
                                                        ...
                                                        <td style=" vertical-align: inherit; ">
                                                            <center>
                                                                <small>{!! (Setting::get('product.gift')*$row->qty) !!}</small>
                                                            </center>
                                                        </td>
                                                ...
                                                @elseif ($row->product_id == 'fast')
                                                    <tr id="tr_" class="warning">
                                                        ...
                                                        <td style=" vertical-align: inherit; ">
                                                            <center>
                                                                <small>{!! Setting::get('product.fast') !!}</small>
                                                            </center>
                                                        </td>
                                                    </tr>
                                                @else
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style=" vertical-align: inherit; ">
                                                            <center>
                                                                <img style=" max-height: 50px;"
                                                                     src="{{ asset('files/products/img/small/'.$row->productCover) }}"
                                                                     alt="4" class="img-responsive"></center>
                                                        </td>
                                                        <td style=" vertical-align: inherit; ">
                                                        ...
                                                        <td style=" vertical-align: inherit; ">
                                                            <small>
                                                                <center>{!! ($row->productPrice*$row->qty) !!}</center>
                                                            </small>
                                                        </td>
                                            ...
                                            <tr class="active">
                                                <td class="text-right" colspan="3"><b>
                                                        <small>Всего товара:</small>
                                                    </b></td>
                                                <td class="text-left"><b>
                                                        <small>
                                                            <center>{{$totalCount}}</center>
                                                        </small>
                                                    </b></td>
                                                <td><b>
                                                        <div id="total_summ">
                                                            <small>
                                                                <center>{{$totalSumm}}</center>
                                                            </small>
                                                        </div>
                                                    </b></td>
                                            </tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <td class="active">
                                                    <small>
                                                        <center>Дополнительная информация</center>
                                                    </small>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <small>{{$order->comment or Null}}</small>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
